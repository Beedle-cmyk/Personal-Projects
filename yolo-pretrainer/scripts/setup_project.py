...
from src.config import (PROJECT_DIRECTORY, DATA_DIRECTORY, LABELS_JSON_FILE, LABEL_CONFIG)
...
auto_trainer.setup_project(label_json=LABELS_JSON_FILE, label_config=LABEL_CONFIG)