...
class Trainer:
    ...
    """Base Class containing YOLO methods for optimized training & tuning models
    ...
    def __init__(self):
        ...
        Args:
            model : YOLO object generated with chosen model
            latest_results : The most recent Results object generated post training by the model
            run_name :
    ...
    def train(self, cfg : Path | str="args.yaml", current_proj_dir : Path | str | None=None, resume : str | Path | None=None):
        ...
        Args:
            cfg : configuration file with arguments/parameters to train model with (default is args.yaml)
            current_project_dir: path to current working project
            resume: path to .pt model file to resume from 
    ...
    def _run(self, 
        ...
        Will retry a maximum of MAX_RETRIES times upon training or tuning failure
    ...
    def stratified_split(self, 
        ...
        Args:
            ...
            current_proj_dir (str | Path | None) : directory
