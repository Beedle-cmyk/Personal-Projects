...
class Trainer:
    ...
    def train(self, cfg="args.yaml", current_project_dir=None):
        """
        ...
        run_name = f"train_{model_name}_imgsz_{imgsz}_epochs_{epochs}"
        checkpoint = project_dir / "runs" / run_name / "weights" / "last.pt"
